...
void
CataCamera::_undistortPoints(const std::vector<cv::Point2f>& pts_in, const std::string& cam_distortion_model, std::vector<cv::Point2f>& pts_out, const cv::Matx33d& rectification_matrix ) const {}

void
CataCamera::_distortPoints(const std::vector<cv::Point2f>& pts_in, const std::string& cam_distortion_model, std::vector<cv::Point2f>& pts_out) const {}
